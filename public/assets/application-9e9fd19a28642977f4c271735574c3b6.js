  ...
  $(function() {
    ...
    if ($('#search_shop').get(0)) {
          ...
          navigator.geolocation.getCurrentPosition((function(_this) {
            return function(pos) {
              ...
              ll = {
                ...
                return_id: $(_this).attr('data-return-id')
              };
              return $.get($(_this).attr('data-href'), ll, function(data) {
                console.log(data);
                return eval(data);
              });
            };
      ...
      if (0 < $('body.feedbacks').size()) {
        ...
        sync = function() {
          $.getJSON('https://yamaokaya1.sharepoint.com/_api/web/lists', function(data) {
            return console.log(data);
          });
          return console.log('sync');
        };
        return $('#sync').on('click', sync);
      }
    }
  });
...
(function() {
  ...
  $($('body.top') ? (ticker = function() {
    return $('#news li:first').fadeOut(function() {
      return $(this).appendTo($('#news')).fadeIn();
    });
  }, setInterval(ticker, 5000)) : void 0);
...
(function() {
  $(function() {
    ...
    $(".tab#recruit").hover(function() {
      return $(this).find('img').attr('src', $('#stabp').attr('src'));
    }, function() {
      return $(this).find('img').attr('src', $('#stab').attr('src'));
    });
    $(".tab#property").hover(function() {
      return $(this).find('img').attr('src', $('#btabp').attr('src'));
    }, function() {
      return $(this).find('img').attr('src', $('#btab').attr('src'));
    });
    if ($("#modal")) {
      $("#modal").dialog();
    }
    if ($("#error_explanation")) {
      return $("#error_explanation").dialog();
    }
  });
